...
public class LibroCollection {
	...
	@InjectLinks({
		...
		@InjectLink(value = "/books?before={before}", style = Style.ABSOLUTE, rel = "previous", title = "Previous llibros", type = MediaType.BOOKS_API_BOOK_COLLECTION, bindings = { @Binding(name = "before", value = "${instance.oldestTimestamp}") }),
