...
insert into users values('admin', MD5('admin'), 'Cris', 'crisdmin@acme.com');
...
select sleep(1);insert into reviews (libroid, username, name, texto) values (1,'admin','Cris','No me ha gustado...');
select sleep(1);insert into reviews (libroid, username, name, texto) values (1,'test','Test','No me ha gustado...');
select sleep(1);insert into reviews (libroid, username, name, texto) values (3,'admin','Cris','Muy guapo');
select sleep(1);insert into reviews (libroid, username, name, texto) values (4,'admin','Cris', 'Muy largo');
